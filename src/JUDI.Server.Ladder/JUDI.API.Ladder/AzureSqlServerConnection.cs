...
{
	// From https://gist.github.com/ChristopherHaws/b1c54b95838f1513bfb74fa1c8e408f3
	...
	public class AzureSqlServerConnection : SqlServerConnection
	{
		...
		public AzureSqlServerConnection(RelationalConnectionDependencies dependencies) : base(dependencies)
		{
		}
		...
		protected override DbConnection CreateDbConnection() => new SqlConnection(this.ConnectionString)
		{
			...
			AccessToken = AsyncUtilities.RunSync(() => new AzureServiceTokenProvider().GetAccessTokenAsync("https://database.windows.net/"))
		};
